...
import { createPj } from './utils/elementFactory'
...
> = (set, get) => ({
  ...
  onNodesChange: (changes: NodeChange<Node<NodeData>>[]) => {
    ...
    const newNodes = applyNodeChanges<Node<NodeData>>(changes, currentPj.nodes)
  ...
  //   // subtreeを挿入
  //   const newNodes = insertAfter(nodesWithoutSubtree, movingNodes, aboveNodeIdx)
